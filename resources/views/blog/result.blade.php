@extends('layouts.new.resultadmin')
...
<div class="table-responsive">
    ...
    <tr>
       ...
       <td><a href="/data/{{ $data->id }}/edit"><input type="submit" name="submit" value="edit"></a>
        <form action="/data/{{ $data->id }}" method="post">
        <input type="submit" name="submit" value="delete">
        {{ csrf_field() }}
        <input type="hidden" name="_method" value="DELETE">
        </form>
         <a href="/view/{{ $data->id }}/buy"><input type="submit" name="submit" value="view"></a>
       </td>
