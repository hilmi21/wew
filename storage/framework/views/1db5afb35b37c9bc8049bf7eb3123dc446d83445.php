...
<link rel="stylesheet" type="text/css" href="/css/css2.css"/>
    ...
    <form action="<?php echo e(url('viewuser')); ?>" method="POST" enctype="multipart/form-data">
    <table>
    <table border="0">
    <tr>
    <td><p>Kode Game :</p></td>
...
<?php echo $__env->make('layouts.new.datauserr', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>